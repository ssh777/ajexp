package org.ajexp.samples.excel.dto;
...
public class SimpleDTO {
    ...
    public SimpleDTO(Long id, String name, SimpleEnum type) {
        this.id = id;
        this.name = name;
        this.type = type;
    }
    ...
    @AjxColumn(headerName = @AjxName(value = "name", locale = AjxLocale.ENGLISH), columnOrder = 2)
